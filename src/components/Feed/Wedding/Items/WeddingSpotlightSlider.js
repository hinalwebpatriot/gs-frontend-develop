...
const WeddingSpotlightSlider = props => (
  <LazyLoadWithServer height="515px" once={true} offset={50}>
    <SpotlightSlider {...props} />
  </LazyLoadWithServer>
);

export default withFetch(api.weddingFeed.getPhotoSlider)(
  WeddingSpotlightSlider
);
