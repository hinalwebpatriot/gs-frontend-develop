...
export const addRingToFav = createRoutine("FAVORITE_RING_ADD");
...
export const addEternityRingToFav = createRoutine("FAVORITE_ETERNITY_RING_ADD");
...
export const addRingFromFavToCompare = createRoutine("FAV_TO_COMPARE_RING_ADD");
...
export const addEternityRingsFromFavToCompare = createRoutine("FAV_TO_COMPARE_ETERNITY_RINGS_ADD");
...
export const removeRingFromFav = createRoutine("FAVORITE_RING_REMOVE");
...
export const removeEternityRingFromFav = createRoutine("FAVORITE_ETERNITY_RING_REMOVE");
...
export const removeAllRingFromFav = createRoutine("FAVORITE_ALL_RINGS_REMOVE");
...
export const removeAllEternityRingFromFav = createRoutine("FAVORITE_ALL_ETERNITY_RINGS_REMOVE");
...
function* pushAddRingWorker({ payload }) {
  const api = yield getContext('api');
  yield call(() => 
    makeFetch(addRingToFav, api.favorite.addProduct, payload));
}
...
function* pushAddEternityRingWorker({ payload }) {
  ...
  const api = yield getContext('api');
  yield call(() =>
    makeFetch(addEternityRingToFav, api.favorite.addProduct, payload)
  );
}
...
function* pushRemoveRingWorker({ payload }) {
  const api = yield getContext('api');
  yield call(() => 
    makeFetch(removeRingFromFav, api.favorite.removeProduct, payload)
  );
}
...
function* pushRemoveEternityRingWorker({ payload }) {
  const api = yield getContext('api');
  yield call(() =>
    makeFetch(removeEternityRingFromFav, api.favorite.removeProduct, payload)
  );
}
...
function* pushRemoveAllRingWorker() {
  const api = yield getContext('api');
  yield call(() =>
    makeFetch(removeAllRingFromFav, api.favorite.removeAllProducts)
  );
}
...
function* pushRemoveAllEternityRingWorker() {
  const api = yield getContext('api');
  yield call(() =>
    makeFetch(removeAllEternityRingFromFav, api.favorite.removeAllProducts)
  );
}
...
function* pushAddAllEternityRingsToCompareWorker() {
  const api = yield getContext('api');
  yield call(() =>
    pushFavToCompare(
...
export function* favoriteWatcher() {
  ...
  yield all([
    ...
    takeLatest(addRingToFav.TRIGGER, pushAddRingWorker),
    takeLatest(addEarringToFav.TRIGGER, pushAddEarringWorker),
    takeLatest(addBraceletToFav.TRIGGER, pushAddBraceletWorker),
    takeLatest(addEternityRingToFav.TRIGGER, pushAddEternityRingWorker),
    ...
    takeLatest(removeRingFromFav.TRIGGER, pushRemoveRingWorker),
    ...
    takeLatest(removeEternityRingFromFav.TRIGGER, pushRemoveEternityRingWorker),
    ...
    takeLatest(removeAllRingFromFav.TRIGGER, pushRemoveAllRingWorker),
    ...
    takeLatest(removeAllEternityRingFromFav.TRIGGER, pushRemoveAllEternityRingWorker),
    ...
    takeLatest(addEternityRingsFromFavToCompare.TRIGGER, pushAddAllEternityRingsToCompareWorker),
  ]);
}
