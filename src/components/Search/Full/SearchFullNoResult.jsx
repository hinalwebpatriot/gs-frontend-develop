        ...
        <div className="row search-category-row">
          <div className="col-md-6">
            <Link to={routing().diamondsFeed}>
              <div className="search-category">
                <img src={search1} alt="search full no result 1" />
          ...
          <div className="col-md-6">
            <Link to={routing().engagementFeed}>
              <div className="search-category">
                <img src={search2} alt="search full no result 2" />
          ...
          <div className="col-md-6">
            <Link to={routing().weddingFeed}>
              <div className="search-category">
                <img src={search3} alt="search full no result 3" />
          ...
          <div className="col-md-6">
            <div className="search-category">
              <img src={search4} alt="search full no result 4" />
