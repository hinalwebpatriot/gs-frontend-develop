...
import CompareShareMain from "./CompareShareMain";
import CompareShareSidebar from "./CompareShareSidebar";
    ...
    return (
      <section className="fav-and-compare-section">
        <div className="container">
          ...
          <CompareWrapper>
            <CompareShareSidebar currentTab={tab} status={status} />
            <CompareShareMain currentTab={tab} status={status} data={data} />
          </CompareWrapper>
        </div>
      </section>
    );
